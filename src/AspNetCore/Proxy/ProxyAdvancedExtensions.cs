    ...
    internal static class ProxyAdvancedExtensions
    {
        ...
        public static async Task<bool> AcceptProxyWebSocketRequest(this HttpContext context, Uri destinationUri)
        {
            ...
            using (var client = new ClientWebSocket())
            {
                ...
                foreach (KeyValuePair<string, Microsoft.Extensions.Primitives.StringValues> headerEntry in context.Request.Headers)
                {
                ...
                {
                    int bufferSize = proxyService.Options.WebSocketBufferSize ?? DefaultWebSocketBufferSize;
